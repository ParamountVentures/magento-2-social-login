...
class B2C extends \Hybrid_Provider_Model_OAuth2
{
    ...
    function initialize()
    {
        ...
        $this->api->authorize_url = "https://login.microsoftonline.com/citymessenger.net/oauth2/v2.0/authorize";
        $this->api->token_url     = "https://login.microsoftonline.com/citymessenger.netoauth2/v2.0/token";
    }
